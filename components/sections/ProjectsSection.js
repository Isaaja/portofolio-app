   ...
   return (
      <section className="pb-10 xl:pt-36 xl:pb-36 transition duration-300 ease-in-out dark:bg-dark">
         <div className="container">
                     ...
                     >
                        ...
                        >
                           <img
                              alt={porto.alt}
                              src={porto.thubmnail}
                              className={`transition w-full duration-300 ease-in-out hover:scale-110 h-52 object-cover object-center dark:border-red-700 ${
            ...
            <div className="flex flex-wrap">
               <div className="w-full px-4">
                  <div className="mx-auto mb-16 text-center mt-10">
                     <h2 className="mb-2 text-2xl font-bold text-dark dark:text-white sm:text-3xl lg:text-5xl">
                        AI Projects
                     </h2>
                  </div>
